...
RED_SPACE_SHIP = pygame.image.load(
    "C:\\Users\\Lennylen\\Documents\\GitHub\\Pygame-Rebooted\\From Tech With Tim\\Space Invaders\\assets\\pixel_ship_red_small.png")
...
class Ship:
    ...
    def shoot(self):
        # cool_down_counter checks to ensure we dont fire rapidly
...
def collide(obj1, obj2):
    ...
    # is object1 overlapping object2 ? with the offset
    return obj1.mask.overlap(obj2.mask, (offset_x, offset_y)) != None # returns (x,y) ; point pf intersection
